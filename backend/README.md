...
## Project Structure
    ...
    ├── testapiautodatamod_112792  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112792`
...
2. Clone this repo and `cd testapiautodatamod_112792`
